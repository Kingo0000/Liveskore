...
$(document).ready(function () {
  ...
  $.ajax({
    url: "https://myapi-nu.vercel.app/standings/premierleague/2024",
    method: "GET",
      ...
      success: function (response) {
        ...
        if (response.matches && Array.isArray(response.matches)) {
          response.matches.forEach(function (match, index) {
            ...
            matchDiv
              .find(".mt")
              .text(`${match.competition.name}, Gwk${match.matchday}`);
            ...
            matchDiv
              .find(".club1")
              .empty()
              .append(homeTeamCrest, "   ", match.homeTeam.shortName);
            ...
            matchDiv
              .find(".club2")
              .empty()
              .append(match.awayTeam.shortName, "   ", awayTeamCrest);
