...
const pl2024 =
  "http://api.football-data.org/v4/competitions/PL/scorers?season=2024&limit=20";
const pl2023 =
  "http://api.football-data.org/v4/competitions/PL/scorers?season=2023&limit=20";
const pl2022 =
  "http://api.football-data.org/v4/competitions/PL/scorers?season=2022&limit=20";
const pl2021 =
  "http://api.football-data.org/v4/competitions/PL/scorers?season=2021&limit=20";

const laliga2024 =
  "http://api.football-data.org/v4/competitions/PD/scorers?season=2024&limit=20";
const laliga2023 =
  "http://api.football-data.org/v4/competitions/PD/scorers?season=2023&limit=20";
const laliga2022 =
  "http://api.football-data.org/v4/competitions/PD/scorers?season=2022&limit=20";
const laliga2021 =
  "http://api.football-data.org/v4/competitions/PD/scorers?season=2021&limit=20";

const bl2024 =
  "http://api.football-data.org/v4/competitions/BL1/scorers?season=2024&limit=20";
const bl2023 =
  "http://api.football-data.org/v4/competitions/BL1/scorers?season=2023&limit=20";
const bl2022 =
  "http://api.football-data.org/v4/competitions/BL1/scorers?season=2022&limit=20";
const bl2021 =
  "http://api.football-data.org/v4/competitions/BL1/scorers?season=2021&limit=20";

const champsl = "http://api.football-data.org/v4/competitions/CL/scorers";

const l12024 =
  "http://api.football-data.org/v4/competitions/FL1/scorers?season=2024&limit=20";
const l12023 =
  "http://api.football-data.org/v4/competitions/FL1/scorers?season=2023&limit=20";
const l12022 =
  "http://api.football-data.org/v4/competitions/FL1/scorers?season=2022&limit=20";
const l12021 =
  "http://api.football-data.org/v4/competitions/FL1/scorers?season=2021&limit=20";

const eredivise2024 =
  "http://api.football-data.org/v4/competitions/DED/scorers?season=2024&limit=20";
const eredivise2023 =
  "http://api.football-data.org/v4/competitions/DED/scorers?season=2023&limit=20";
const eredivise2022 =
  "http://api.football-data.org/v4/competitions/DED/scorers?season=2022&limit=20";
const eredivise2021 =
  "http://api.football-data.org/v4/competitions/DED/scorers?season=2021&limit=20";

const sa2024 =
  "http://api.football-data.org/v4/competitions/SA/scorers?season=2024&limit=20";
const sa2023 =
  "http://api.football-data.org/v4/competitions/SA/scorers?season=2023&limit=20";
const sa2022 =
  "http://api.football-data.org/v4/competitions/SA/scorers?season=2022&limit=20";
const sa2021 =
  "http://api.football-data.org/v4/competitions/SA/scorers?season=2021&limit=20";

const elc2024 = `http://api.football-data.org/v4/competitions/ELC/scorers?season=2024&limit=20`;
...
const ppl2024 = `http://api.football-data.org/v4/competitions/PPL/scorers?season=2024&limit=20`;
...
router.get("/laliga/2024", async (req, res) => {
  try {
    // Make a request to the football API to fetch all competitions
...
router.get("/bundesliga/2024", async (req, res) => {
  try {
    // Make a request to the football API to fetch all competitions
...
router.get("/league1/2024", async (req, res) => {
  try {
    // Make a request to the football API to fetch all competitions
...
router.get("/eredivise/2024", async (req, res) => {
  try {
    // Make a request to the football API to fetch all competitions
...
router.get("/seriaa/2024", async (req, res) => {
  try {
    // Make a request to the football API to fetch all competitions
...
router.get("/championship/2024", async (req, res) => {
  try {
...
router.get("/primeraliga/2024", async (req, res) => {
  try {
    const { matchday } = req.params;
    // Make a request to the football API to fetch all competitions
